...
public class StepDefinitions {
    ...
    public void assert_that_more_then(String string, String string2) {
      int raitingOne = SEARCH_RESULT_PAGE_OBJECTS.getRatingFirstPicture();
      int raitingTwo = SEARCH_RESULT_PAGE_OBJECTS.getRatingSecondPicture();
      assertFalse(raitingOne<raitingTwo);
